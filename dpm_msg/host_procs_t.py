...
import dpm_msg.proc_info_t

class host_procs_t(object):
    __slots__ = ["timestamp", "hostname", "num_procs", "procs"]

    __typenames__ = ["int64_t", "string", "int32_t", "dpm_msg.proc_info_t"]
    ...
    def _encode_one(self, buf):
        ...
        for i0 in range(self.num_procs):
            assert self.procs[i0]._get_packed_fingerprint() == dpm_msg.proc_info_t._get_packed_fingerprint()
    ...
    def _decode_one(buf):
        ...
        self.procs = []
        for i0 in range(self.num_procs):
            self.procs.append(dpm_msg.proc_info_t._decode_one(buf))
        return self
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0x40e0393990ab6db5+ dpm_msg.proc_info_t._get_hash_recursive(newparents)) & 0xffffffffffffffff
